...
BUCKET_NAME = "de-zoomcamp-2026-raw-data"
PROJECT_ID = "de-zoomcamp-2026-486008"
...
def upload_to_gcs(file_path, max_retries=3):
    #This places the file inside a specific folder in  bucket
    blob_name = f"yellow_tripdata_2024/{os.path.basename(file_path)}"
